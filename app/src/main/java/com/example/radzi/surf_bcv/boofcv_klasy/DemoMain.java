package com.example.radzi.surf_bcv.boofcv_klasy;
...
import com.example.radzi.surf_bcv.R;
import com.example.radzi.surf_bcv.pokazWzor;
import com.example.radzi.surf_bcv.surf;
...
public class DemoMain extends Activity implements ExpandableListView.OnChildClickListener {
	...
	private void createGroups() {
		...
		////////////////////////
		recognition.addChild("surf", surf.class);
		recognition.addChild("pokazWzor", pokazWzor.class);
		////////////////
